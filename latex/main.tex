...
\documentclass[
    ...
    final               % Modo final com imagens embutidas
]{abntex2}
...
\input{capitulos/cap1-introducao}
\input{capitulos/cap2-referencial}
\input{capitulos/cap3-trabalhos-relacionados}
\input{capitulos/cap4-metodologia}
\input{capitulos/cap5-resultados}
\input{capitulos/cap6-mitogenoma}
\input{capitulos/cap7-consideracoes}
...
% ---- REFERÊNCIAS ----
% .bbl pré-compilado (renomeado para .tex para evitar tratamento especial do Overleaf)
\input{referencias-compiladas.tex}
